...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.Creater = field.NewString(tableName, "creater")
	_category.Updater = field.NewString(tableName, "updater")
	_category.CreatedAt = field.NewField(tableName, "created_at")
	_category.UpdatedAt = field.NewField(tableName, "updated_at")
	_category.DataUpdatedAt = field.NewField(tableName, "data_updated_at")
...
func (c *category) updateTableName(table string) *category {
	...
	c.Creater = field.NewString(table, "creater")
	...
	c.DataUpdatedAt = field.NewField(table, "data_updated_at")
...
type ICategoryDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []model.Category, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (c categoryDo) FilterWithNameAndRole(name string, role string) (result []model.Category, err error) {
