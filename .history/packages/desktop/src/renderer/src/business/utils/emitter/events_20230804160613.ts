...
function emitRefreshRightContentPage(p: { id: number | string }) {
  emitter.emit('refreshRightContentPage', p)
}

function listenerRefreshRightContentPage(callback: (p: { id: number | string }) => void) {
