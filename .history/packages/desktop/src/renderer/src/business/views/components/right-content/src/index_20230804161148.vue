...
import { listenerOpenRightContentPage, listenerRefreshRightContentPage } from '@/business/utils'
...
const handleUpdate = () => {
  eventStore.openUpdateAccountDrawer({ id: accountId })
}

const open = ref<boolean>(false)
const accountId = ref UnwrapRef<<number | string>>(0)
...
const setRemoteData = ({ id: accountId }) => {
  // 假设从服务器获取到信息
