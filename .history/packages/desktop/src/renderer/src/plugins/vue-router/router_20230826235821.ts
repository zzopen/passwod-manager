...
import { BUILT_IN_ROUTES, LAYOUT_COMPONENT, ROOT_ROUTE, HOME_ROUTE } from '../../routers/route'
import type { AppRouteRecordRaw } from '@renderer/routers/route'

console.log('LAYOUT_COMPONENT:', LAYOUT_COMPONENT)
const User = {
