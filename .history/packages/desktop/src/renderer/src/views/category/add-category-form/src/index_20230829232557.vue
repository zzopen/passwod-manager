...
const categoryStore = useSecretCategoryStore()
...
const options = computed(() => {
  console.log('categoryStore.categorySelectOptions:', categoryStore.categorySelectOptions)
  return categoryStore.categorySelectOptions
})
