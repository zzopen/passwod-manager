...
import { secretBook } from '../../../../../apis/actions/secret-book/index';

defineOptions({ name: 'CipherRight', inheritAttrs: false })

const state = reactive<{secretBookDetailOpen: boolean, secretBookDetailProps:DataSource}>({
  secretBookDetailOpen: false
  secretBookDetailProps: {
    dataSource: {}
  }
})
