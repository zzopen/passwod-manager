...
export const logger = {
  debug: (msg: any[] | any, scope = 'default') => {
    return debug(defaultLogger, msg, scope)
  },
  info: (msg: any[] | any, scope = 'default') => {
    return info(defaultLogger, msg, scope)
  },
  warn: (msg: any[] | any, scope = 'default') => {
    return warn(defaultLogger, msg, scope)
  },
  error: (msg: any[] | any, scope = 'default') => {
    return error(defaultLogger, msg, scope)
  },
  fatal: (msg: any[] | any, scope = 'default') => {
    return fatal(defaultLogger, msg, scope)
  }
}
