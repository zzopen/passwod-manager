import { nodePath, nodeProcess, is, nativeImage, isLinux, isMac, isWin } from '@main/shared'
import { shell, BrowserWindow, globalShortcut } from 'electron'
import cipherIco from './cipher.ico?asset'
...
function createWindow(): BrowserWindow {
  // const tray = new Tray(nativeImage.createFromPath(cipherIco))
  // console.log('tray:', nativeImage.createFromPath(cipherIco))

  const mm = nativeImage.createFromPath(cipherIco)
  let icon = ''
